...
<html>
  <head>
    <meta charset="UTF-8">
    <title>FHC Ingenieros | Panel de Administracion</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b>FHC</b>Ingenieros</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>FHC</b>Ingenieros</span>
        </a>
   ...
   <?php endif; ?>
    ...
    <?php endif;?>
      ...
      <div class="content-wrapper">
        ...
        <strong>Copyright &copy; 2017 <a href="http://tecnocloudusa.com/" target="_blank">Tecnocloud</a></strong>
      </footer>
      <?php else:?>
        <?php if(isset($_GET["view"]) && $_GET["view"]=="clientaccess"):?>
<div class="login-box">
      <div class="login-logo">
        <a href="./"><b>FHC</b>Ingenieros</a>
      </div><!-- /.login-logo -->
